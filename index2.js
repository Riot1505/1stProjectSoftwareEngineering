...
function creategoal(Goalname, description){
    ...
    button.addEventListener('click', function() {
        resultfordel = confirm("You can undo a deletion. However, if you were to leave this session immediately after deletion, then you will no longer be able to undo this action. Are you sure you want to delete this goal?");
        if(resultfordel){
...
window.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
        result = this.confirm(`Welcome to the goal tracker! You can start off this app by selecting the +Add Goal butt on the bottom right hand side, which will create your own custom and personal goal! The benefit is the fact that the goal button is easily and readily available to you, and you will be able to quickly access goal customization and creation.`)
        if(result != false){
